  ...
  return (
    <header className="sticky top-0 z-50 flex items-center px-4 justify-between max-w-screen bg-white ">
      <div className="flex items-center space-x-1">
        ...
        <h1 className="hidden md:inline-flex text-gray-700 text-2xl self-end">
          Docs
        </h1>
      </div>

      <div
        className="relative flex items-center px-3 sm:px-5 py-2  bg-[#F1F3F4] text-gray-600 rounded-md focus-within:shadow-default focus-within:bg-white w-[200px] max-w-2xl md:flex-grow m-2 overflow-hidden"
      >
        <Icon
          name="search"
          size="2xl"
